...
BOT_TOKEN = "6802368803:AAEBVTpfvbcdkddz_03PVEQUJCO-Bzw6vCU"
PAYMENT_CHANNEL = "@gmeepayout " #add payment channel here including the '@' sign
OWNER_ID = 5853493137 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@SpotterSignal", "@AirdropSpotter"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
              #you can add as many channels here and also add the '@' sign before channel username
Daily_bonus = 0.5 #Put daily bonus amount here!
Mini_Withdraw = 30  #remove 0 and add the minimum withdraw u want to set
